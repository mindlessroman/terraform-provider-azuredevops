	...
	return &schema.Resource{
		...
		Schema: map[string]*schema.Schema{
			"project_id": {
				...
				Description:      "The ID of the project in which to search for git repository",
			},
			"name": {
				Type:             schema.TypeString,
				Optional:         true,
				...
				DiffSuppressFunc: suppress.CaseDifference,
				Description:      "The name of the git repository to search for",
			},
			"include_hidden": {
				Type:        schema.TypeBool,
				Optional:    true,
				Default:     false,
				Description: "If true, search for hidden git repository",
			},
			"repositories": {
				Type:        schema.TypeSet,
				Computed:    true,
				Set:         getGitRepositoryHash,
				Description: "The git repositories found",
